...
/**
 * Created by Figli on 15.02.2016.
 */
public class DoneTaskAdapter extends TaskAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (item.isTask()) {
            ...
            taskViewHolder.quuantityShort.setTextColor(resources.getColor(R.color.secondary_text_disabled_material_light));
            taskViewHolder.priority.setColorFilter(resources.getColor(task.getPriorityColor()));
            taskViewHolder.priority.setImageResource(R.drawable.ic_check_circle_white_48dp);

            final PopupMenu popupMenu = new PopupMenu(context, taskViewHolder.cardMenu);
            popupMenu.inflate(R.menu.menu_done_card);
